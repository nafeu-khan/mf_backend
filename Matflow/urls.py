...
from matflow_test.views import login,signup,display_group,test_page,display_correlation,eda_barplot,display_correlation_featurePair,eda_pieplot
...
urlpatterns = [
    ...
    path('api/eda_barplot/', eda_pieplot, name='display-api'),
